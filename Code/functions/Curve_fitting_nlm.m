function [mdlnlm fitresult gofit rp]=Curve_fitting_nlm(initialmd,modelnlmreal,modelfitreal,Lowerboundary,Upperboundary,ylabelname,name,Plotornot,betainitial)
...
rp(2,1)=Rsqaure;
if(Plotornot==1)
plot4fit(tbl.Age,Data_rremain,fitresult,name,ylabelname,rp(1,1),rp(2,1));
end