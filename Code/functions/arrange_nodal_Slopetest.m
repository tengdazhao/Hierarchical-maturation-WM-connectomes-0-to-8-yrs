...
% %figure;imagesc(tempcolornodeplot);colormap(myslopecmap);hold on; 
% %tempcolornodeplot=(20+log10(tempcolornodeplot./100));
% %load('D:\Documents\OneDrive - bnu.edu.cn\My_publications\0-8years\stats\FinalFigs\myslopecmap.mat')
...
% hold off;
% set(gca,'YTick',flip(size(tempcolornodeplot,1)-clpall+5),'YTickLabel',[sysname(1,numone)]);
% set(gca,'XTick',[Fitted_Subgroup],'XTickLabel',[0 0.5 1 1.5 2 2.5 3 3.5 4 5 6 8]);
% set(gcf,'Color',[1 1 1]) ;
% set(gcf,'position', [1 70 970 800]);
% set(gcf, 'PaperPositionMode', 'auto');set(gca, 'fontsize',20,'LineWidth',0.1,'FontWeight','bold');
% print(gcf,'-dtiff','-r300',[result_name 'SlopeHer4c_MA_FDRnn.tif']); close all;
...
%%%%%%%%%%%%%%%%%%%%%
%SVR
load(['D:\Documents\OneDrive - bnu.edu.cn\My_publications\0-8years\Gretna_results\par500FN\NodalEfficiency\NodalEfficiency.mat']);
nodal_eff=Ne';
dirsvr=(Pathnewplot);
